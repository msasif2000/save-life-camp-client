...
const Testimonial = () => {
    ...
    return (
        <div>
            ...
            <p data-aos="fade-left" data-aos-duration="1000" className="text-xl text-center italic my-2">What our beautiful participants saying about SAVE LIFE MEDICAL CAMP!</p>
