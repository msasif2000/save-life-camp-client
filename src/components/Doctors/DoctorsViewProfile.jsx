    ...
    return (
        <div className="mt-8 space-y-4 xl:max-w-screen-lg 2xl:max-w-screen-xl mx-auto lg:px-4 px-2">
            ...
            <div className="md:flex w-full justify-center gap-12">
                <div className="bg-grn text-white p-2 w-full flex flex-col justify-center">
                    <h2 className="text-xl font-bold">Education: </h2>
                    <h1>{education}</h1>

                    <h1><span className="font-bold">Registration No: </span>{reg_No}</h1>
                </div>
                <div className="bg-grn text-white p-2 w-full">
            ...
            <div className="bg-grn text-white p-2 items-center flex flex-col">
