...
const Contact = () => {
    return (
        <div className="bg-ic3 p-4 rounded">
            <div className="xl:max-w-screen-lg 2xl:max-w-screen-xl mx-auto lg:px-4 px-2 my-20">
                ...
                <div className="flex items-center justify-center gap-1 text-xl mt-12">
                    <BiPhoneCall className="text-3xl" /> <span> +880 123456789</span>
                </div>
                ...
                <div className="lg:flex gap-2 w-full justify-between">
                    <div data-aos="fade-right" className="mt-8 rounded-bl-2xl rounded-tr-3xl w-full bg-ic2 p-4 ">
                    ...
                    <div data-aos="fade-down" className="mt-8 rounded-bl-2xl rounded-tr-3xl w-full bg-ic1 p-4">
                        <h2 className="text-2xl text-center">For Media Inquiries</h2>
                        <div className="flex items-center justify-center gap-1 text-xl">
                            <BiPhoneCall className="text-3xl" /> <span> +123-456-7980</span>
                        </div>
                        <div className="flex items-center justify-center gap-1 text-xl">
                            <AiOutlineMail className="text-3xl" /> <span> media@slmc.org  </span>
                        </div>
                    </div>
                    <div data-aos="fade-left" className="mt-8 rounded-bl-2xl rounded-tr-3xl w-full bg-ic2 p-4 ">
