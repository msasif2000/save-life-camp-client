...
const InfoGraph = () => {
    return (
        <div className="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-8 mt-20 mx-auto px-4 bg-sl1 py-8 rounded-lg">
            <div data-aos="fade-right" className="flex items-center gap-2 border-l-8 rounded-lg border-txt2 mx-auto">
            ...
            <div data-aos="fade-up" className="flex items-center gap-2 pl-1 border-l-8 rounded-lg border-txt2 mx-auto">
            ...
            <div data-aos="fade-left" className="flex items-center gap-2 border-l-8 rounded-lg border-txt2 mx-auto">
