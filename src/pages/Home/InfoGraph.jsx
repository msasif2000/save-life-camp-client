...
const InfoGraph = () => {
    return (
        <div className="mt-16 flex justify-between">
            <div data-aos="fade-right" className="flex items-center gap-2 pl-1 border-l-4 rounded-lg border-grn">
            ...
            <div data-aos="fade-up" className="flex items-center gap-2 pl-2 border-l-4 rounded-lg border-grn">
            ...
            <div data-aos="fade-left" className="flex items-center gap-2 pl-1 border-l-4 rounded-lg border-grn">
